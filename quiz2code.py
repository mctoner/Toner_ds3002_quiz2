...
apikey="S9SK7NK34k62ZL6sUxKTR1phiyCaoa0d2QpsESjo" #my api key
...
if stock_json['quoteResponse']['result']==[]: #what prints when the stock ticker is not known
...
elif response.status_code != 204: #if stock ticker is entered correctly & not empty...
    ...
    with open('apistocks.csv', 'a', newline='') as csv_obj:  
    #Pass the CSV  file object to the writer() function and pass in 'newrow'
        ...
        csv_obj.close() #close the file object 
